...
class MathTexHelpList extends StatelessWidget {
  const MathTexHelpList({super.key});

  // List from https://github.com/simpleclub/flutter_math/blob/main/example/lib/supported_data.dart
  static const supportedData = {
    'Accents': [
      r"a'",
      r'\tilde{a}',
      r"a''",
                    ...
                    Padding(
                      ...
                      child: ClipRRect(
                        ...
                        child: GestureDetector(
                          onTap: () {
                            Clipboard.setData(
                                ClipboardData(text: mathTexText));
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text(
                                  t.tools.mathtex.copied_to_clipboard,
                                ),
                              ),
                            );
                          },
