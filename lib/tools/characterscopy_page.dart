                ...
                showDialog(
                  ...
                  builder: (context) {
                    return AlertDialog(
                      ...
                      content: Text(t.tools.characterscopy.important_description),
                      actions: [
                        TextButton(
                          onPressed: () {
            ...
            children: [
              ...
              Padding(
                ...
                child: TextField(
                  ...
                  onChanged: (value) {
                    setState(() {
                      filteredCharactersList = charactersList.where((character) {
                        return character.name.toLowerCase().contains(value.toLowerCase()) ||
                               character.character.toLowerCase().contains(value.toLowerCase());
                      }).toList();
                    });
                  },
                ),
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemCount: filteredCharactersList.length,
                  itemBuilder: (context, index) {
                    final character = filteredCharactersList[index];
                    return Card(
                      elevation: 0,
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(t.tools.characterscopy.copied_to_clipboard),
