...
class _SoundMeterPage extends State<SoundMeterPage> {
  ...
  void startListening() async {
    try {
      ...
      showOkTextDialog(context, t.generic.error,
          t.tools.soundmeter.error.impossible_to_start_the_sound_meter);
      if (kDebugMode) {
        print(exception);
      }
    }
  ...
  void onData(NoiseReading noiseReading) {
    setState(() {
      ...
      if (meanDecibel == double.infinity ||
          meanDecibel == double.negativeInfinity) {
        meanDecibel = 0.0;
      }
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Text(
                  "${meanDecibel.toStringAsFixed(2)} ${t.tools.soundmeter.decibels}",
                  style: const TextStyle(fontSize: 24),
                ),
                Text(
                  "${maxDecibel.toStringAsFixed(2)} ${t.tools.soundmeter.decibels}",
